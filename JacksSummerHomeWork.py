...
######################################################           
def funcGolf():
    print ("This is the GOLF funnction")
######################################################           
def funcInv():
...
7. Exit""")
            ...
            if   answer=="1": origin = UK;break
            elif answer=="2": origin = France;break
            elif answer=="3": origin = Poland;break
            elif answer=="4": origin = Germany;break
            elif answer=="5": origin = NewYork;break
            elif answer=="6": origin = Australia;break
            elif answer=="7": return()
            else: input ("ERROR: Enter 1..7. Press ENTER to try again");continue
...
7. Exit""")
            ...
            if   answer=="1": dest = UK;break
            elif answer=="2": dest = France;break
            elif answer=="3": dest = Poland;break
            elif answer=="4": dest = Germany;break
            elif answer=="5": dest = NewYork;break
            elif answer=="6": dest = Australia;break
            elif answer=="7": return()
            else: input ("ERROR: Enter 1..7. Press ENTER to try again");continue
...
def funcCurrencyConverter():
    ...
    print ("\nIf you convert %.2f %s you will receive %.2f %s" % (amountToExchange, currencyFrom, amountReceived, currencyTo ))
...
5. Exit application""")
    ...
    if answer=="1": funcInv()
    elif answer=="2": funcTZ()
    elif answer=="3": funcGolf()
    elif answer=="4": funcCurrencyConverter()
    elif answer=="5": sys.exit()
    else: input ("ERROR: Enter 1..4. Press Enter to try again");continue
